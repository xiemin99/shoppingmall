...
<script type="text/javascript">
	function queryPage() {
		var queryJsonVal = document.getElementById("queryJsonStr").value;
		window.location.href = "${pageContext.request.contextPath}/customer/toQuery?queryJsonVal=" + encodeURI(queryJsonVal);
	}
...
<table  width="100%" border="1" cellpadding="0" cellspacing="1" class="tableLine DoubleColorTable" >
	...
	<tr>
		<td colspan="6">
			<a href="javascript:void(0);" onclick="queryPage()">转到查询</a>
			&nbsp;&nbsp;
	...
	<tr>
		<td colspan="6" align="center">
			<input type="hidden" id="queryJsonStr" value='${queryJsonVal}'/>
